...
plugins {
    java
    id("io.github.dnalchemist.gitlab-code-quality-gradle") version "{version_stable}"
}
----
...
plugins {
    java
    id("io.github.dnalchemist.gitlab-code-quality-gradle") version "{version_snapshot}"
}
----
